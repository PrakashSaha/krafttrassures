...
export default async function CategoriesPage({ params }: { params: Promise<any> }) {
      ...
      <main className="min-h-screen bg-[#FAF7F2] py-20 lg:py-32">
        <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
          ...
          <div className="mb-16 lg:mb-24 text-center">
            <span className="font-sans text-[10px] tracking-[0.4em] text-[#B8894A] uppercase block mb-6">{t('categories')}</span>
            <h1 className="font-serif text-5xl lg:text-7xl text-black mb-8">{t('title')}</h1>
                ...
                <div className="relative aspect-[4/5] overflow-hidden bg-zinc-100">
                  {item.image ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-zinc-200">
                      <span className="font-sans text-xs text-black/20 uppercase tracking-widest">[EN] No Image</span>
                    </div>
                  )}
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-8 lg:p-10">
                    ...
                    <div className="flex items-center gap-3 text-white border-t border-white/20 pt-6 mt-2">
                      <span className="font-sans text-[10px] tracking-[0.25em] uppercase font-bold">{t('view_details')}</span>
